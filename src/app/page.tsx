    ...
    <div className="animate-fadeIn">
          ...
          <div className="text-center max-w-4xl mx-auto py-20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/packages">
                <Button
                  size="lg"
                  className="bg-primary-500 text-white hover:bg-primary-600 shadow-lg font-bold"
                >
                  View Programs
                </Button>
              </Link>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white font-varsity">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto">
            Born from a passion for excellence, JAG FC develops young soccer
            talent through elite coaching, competitive play, and a commitment to
            building character both on and off the field.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card hover padding="lg" className="bg-white border border-gray-200">
            <div className="text-center">
              ...
              <p className="text-gray-700">
                Professional coaches with proven track records developing
          ...
          <Card hover padding="lg" className="bg-white border border-gray-200">
            <div className="text-center">
              ...
              <p className="text-gray-700">
                Tournament victories and league championships - our teams
          ...
          <Card hover padding="lg" className="bg-white border border-gray-200">
            <div className="text-center">
              ...
              <p className="text-gray-700">
                Rising through challenges, building resilience, and emerging
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700">
              See our teams in action - building skills, winning titles
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                At JAG FC, we embody the spirit of the phoenix - rising,
                evolving, and conquering. Our training philosophy combines
                technical mastery with mental toughness and tactical
                intelligence.
              </p>
              <ul className="space-y-4 text-gray-800">
                <li className="flex items-start">
                  <span className="text-primary-600 text-xl mr-3 font-bold">
                    ✓
                  </span>
                  <span>
                    ...
                    - Master the fundamentals, perfect the advanced
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-accent-600 text-xl mr-3 font-bold">
                    ✓
                  </span>
                  <span>
                    ...
                    - Train like champions, play like warriors
                  </span>
                </li>
                <li className="flex items-start">
                  <span className="text-secondary-600 text-xl mr-3 font-bold">
                    ✓
                  </span>
                  <span>
                    <strong className="text-secondary-600">Team Unity</strong> -
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gray-50 font-varsity">
        <div className="text-center mb-12">
          ...
          <div className="h-1 w-32 bg-primary-500 mx-auto mb-6"></div>
          <p className="text-xl text-gray-700">
            Elite training from beginner to advanced competitive levels
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card
            hover
            className="text-center bg-white border-2 border-primary-200 hover:border-primary-500"
          >
          ...
          <Card
            hover
            className="text-center bg-white border-2 border-accent-200 hover:border-accent-500"
          >
            <div className="text-4xl font-black text-accent-600 mb-2">
              U11-U13
            </div>
            <h3 className="text-xl font-bold text-accent-600 mb-2">
              Phoenix Elite
            </h3>
          ...
          <Card
            hover
            className="text-center bg-white border-2 border-secondary-200 hover:border-secondary-500"
          >
            <div className="text-4xl font-black text-secondary-600 mb-2">
              U14-U16
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-gray-700 italic mb-4">
                  "JAG FC transformed my son's game. The coaching is world-class
                  and the competitive environment pushed him to excel."
                </p>
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-gray-700 italic mb-4">
                  "Best decision we made! Multiple tournament wins and my
                  daughter's confidence has soared. JAG FC is the real deal."
                </p>
            ...
            >
              <div className="mb-4">
                ...
                <p className="text-gray-700 italic mb-4">
                  "The phoenix mentality is real - my kids learned to rise after
                  every challenge. More than soccer, it's life lessons."
                </p>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gray-50 font-varsity">
        <Card
          className="bg-gradient-to-r from-primary-500 to-accent-500 text-white text-center shadow-xl flex flex-col justify-center items-center"
          padding="lg"
        >
          <Image
            src="/images/phoenix.png"
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/packages">
              <Button
                size="lg"
                className="bg-white !text-primary-600 hover:bg-gray-100 hover:!text-white font-bold shadow-lg"
              >
                View Programs
              </Button>
            </Link>
            <Link href="/auth">
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-primary-600 font-bold"
              >
                Join JAG FC Now
              </Button>
            </Link>
